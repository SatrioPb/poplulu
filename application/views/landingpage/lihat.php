...
<body>
    ...
    <script>
        function selectTime(time) {
            ...
            // Tambahkan efek visual di sini, contohnya mengubah warna tombol saat diklik
            var previouslySelectedButton = document.querySelector('.btn-group .btn[data-selected="true"]');

            // Reset warna tombol sebelumnya
            if (previouslySelectedButton) {
                previouslySelectedButton.style.backgroundColor = '#9b0060';
                previouslySelectedButton.removeAttribute('data-selected');
            }

            // Set efek visual untuk tombol yang diklik
            var clickedButton = event.currentTarget;
            clickedButton.style.backgroundColor = '#A9A9A9';
            clickedButton.setAttribute('data-selected', 'true');

            // Lakukan tindakan lain yang diperlukan, misalnya mengirim data waktu yang dipilih ke server, dsb.
