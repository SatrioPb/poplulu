					...
					<div class="card" style="border-radius: 1rem;">
						<div class="row g-0">
							<div class="col-md-6 col-lg-5 d-none d-md-block">
								<img src="assets/lemari.png" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
							</div>
								...
								<div class="card-body p-4 p-lg-5 text-black">
									...
									<form class="user" method="POST" action="<?= base_url('login/proses_login') ?>">
										...
										<div class="form-outline mb-4">
											<input type="text" class="form-control" id="username" placeholder="Enter Username" autocomplete="off" required name="username">
										</div>
										...
										<button type="submit" class="btn btn-block text-light" name="login" style="background-color: #9B0060;">
											Login
										</button>
